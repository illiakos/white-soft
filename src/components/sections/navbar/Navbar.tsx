...
const Navbar: FC = () => {
    ...
    return (
        <header className={"flex flex-row justify-between lg:justify-between mx-8 sm:mx-16 md:mx-20 lg:mx-24 lg:mx-28 2lg:mx-32 sm:py-8 items-center bg-white-bg"}>
            ...
            <ul className={"text-xl font-medium hidden lg:flex lg:flex-row flex-col gap-x-1 lg:gap-x-6 lg:gap-y-0 gap-y-4 lg:mb-0 mb-6 items-center text-text-black transition-all duration-500 z-[111]"}>
                <li>
                    <Link href={"#about"}
