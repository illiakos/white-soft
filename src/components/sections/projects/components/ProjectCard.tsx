...
export default function ProjectCard({title, imageSrc, comingSoon, description}) {

    return (
        comingSoon ?
            //Project is coming soon display ? and text coming soon
        ...
        :
                ...
                //Normal project display name, description and image
                <div className={"p-8 flex flex-col bg-white rounded-xl items-center justify-center"}>
                    <div className={"relative w-2/3 pb-56"}>
                        <Image
                            draggable={false}
                    ...
                    <button className={"bg-primary-blue text-xl text-white font-semibold w-full rounded-xl py-4 mt-4"}>Read more</button>
                </div>
