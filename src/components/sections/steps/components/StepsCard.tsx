...
export default function StepsCard({title, imageSrc, id} :StepsCardProps) {
    ...
    return (
        <div className={"relative p-4 w-96 flex flex-col bg-white rounded-xl items-center justify-center"}>
            <p className={"absolute left-4 top-4 text-primary-blue font-semibold text-xl"}>{id}</p>
            ...
            <h2 className={"text-primary-blue text-center font-bold text-2xl mb-8 self-center"}>{title}</h2>
        </div>
    )
}
